param(
    ...
    [String]$UserName, 
    [Parameter(Mandatory=$false)]
    [String]$WorkerName = "ID=OmarMiner-v2.0", 
    [Parameter(Mandatory=$false)]
    [Int]$API_ID = 0, 
    [Parameter(Mandatory=$false)]
    [String]$API_Key = "", 
...
$WalletDonate = "1ABXrz8KmrR73XZWgnBob1JTwBDusjDdsf"
$UserNameDonate = "1ABXrz8KmrR73XZWgnBob1JTwBDusjDdsf"
$WorkerNameDonate = "OmarMiner-v2.0"
$WalletBackup = $Wallet
